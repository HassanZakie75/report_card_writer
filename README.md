Basic report card writer from a preset list of commend. Will auto generate according to grade level. This code is written for IB MYP science, math and physics subjects
